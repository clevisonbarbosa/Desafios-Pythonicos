...
def front_x(words):
    # lista_de_x = []
    # lista_diferente_de_x = []
    # for w in words:
    #     if w[0] == 'x':
    #         lista_de_x.append(w)
    #     else:
    #         lista_diferente_de_x.append(w)
    # return sorted(lista_de_x) + sorted(lista_diferente_de_x)

    lista_de_x = sorted([w for w in words if w[0] == 'x'])
    lista_diferente_de_x = sorted([w for w in words if w[0] != 'x'])
    return lista_de_x + lista_diferente_de_x
